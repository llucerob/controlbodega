            ...
            <div class="row">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">Reservas Materiales</li>
                    </ol>
                </div>
            </div>
        </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex">
                                                    ...
                                                    <button type="button" class="btn btn-success btn-sm" data-bs-toggle="modal" data-bs-target="#modalEntregar{{$key}}">Entregar</button>
                                                </div>
                                            </td>
                                                    ...
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body"> 
                                                            <div class="modal-toggle-wrapper">  
                                                              ...
                                                              <h4 class="text-center pb-2">¿Realmente desea Entregar estos Materiales?</h4>
                                                              <p class="text-center">Esta acción no se puede deshacer</p>
                                                              
                                                                <a class="btn btn-success d-flex text-center" href="{{ route('materiales.reservadosentrega',$a['actividad_id']) }}">Entregar</a>
