        ...
        <div class="row starter-main">
            <div class="col-lg-12">
                <form class="card" action="{{ route('actividades.create2')}}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="card-body">
                            <div class="row">
                                <input type="hidden" name="paso" value="pas_1">
                                
                                
                                <div class="col-sm-6 col-md-8">
                                    <div class="form-group mb-3">
                                        <label class="form-label">Nombre</label>
                                        <input class="form-control" required type="text" name="actividad[nombre]" placeholder="Ingrese nombre de Actividad">
                                    </div>
                                </div>
                                <div class="col-sm-6 col-md-4">
                                    <div class="form-group mb-3">
                                        <label class="form-label">Ubicación</label>
                                        <input class="form-control" required  type="text" name="actividad[ubicacion]" placeholder="Ingrese Ubicación">
                                    </div>
                                </div>
